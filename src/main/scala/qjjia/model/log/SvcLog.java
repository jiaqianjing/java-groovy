...
public class SvcLog extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public MediaData mediaData;
   ...
   */
  public SvcLog(Integer type, CharSequence sid, CharSequence uid, Long timestamp, Integer ip, CharSequence callName, java.util.List<RawLog> logs, qjjia.model.log.MediaData mediaData) {
    this.type = type;
    this.sid = sid;
    this.uid = uid;
  ...
  public void put(int field$, Object value$) {
    ...
    case 7: mediaData = (qjjia.model.log.MediaData)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public qjjia.model.log.MediaData getMediaData() {
    return mediaData;
  }
   ...
   * @param value the value to set.
   */
  public void setMediaData(qjjia.model.log.MediaData value) {
  ...
  /**
   * RecordBuilder FORInstance SvcLog instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SvcLog>
    ...
    private qjjia.model.log.MediaData mediaData;
    ...
    /** Sets the value of the 'mediaData' field */
    public Builder setMediaData(qjjia.model.log.MediaData value) {
    ...
    public SvcLog build() {
      try {
        ...
        record.mediaData = fieldSetFlags()[7] ? this.mediaData : (qjjia.model.log.MediaData) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
